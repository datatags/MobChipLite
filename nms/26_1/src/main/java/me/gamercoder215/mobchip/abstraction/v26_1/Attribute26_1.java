...
final class Attribute26_1 extends RangedAttribute implements Attribute {
    ...
    public Attribute26_1(RangedAttribute a) {
    ...
    public Attribute26_1(NamespacedKey key, double defaultV, double min, double max, boolean clientSide) {
