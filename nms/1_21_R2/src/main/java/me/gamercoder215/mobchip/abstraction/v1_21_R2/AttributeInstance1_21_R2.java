...
import static org.bukkit.craftbukkit.v1_21_R2.attribute.CraftAttributeInstance.convert;
...
final class AttributeInstance1_21_R2 implements AttributeInstance {
    ...
    public AttributeInstance1_21_R2(Attribute a, net.minecraft.world.entity.ai.attributes.AttributeInstance handle) {
        this.a = a;
        this.handle = handle;
    }
