...
final class NavigationPath1_21_R7 implements NavigationPath {
    private String name;
    private final Mob m;
    private final Path handle;
    private double speedMod;

    NavigationPath1_21_R7(@NotNull Path nms, @NotNull Mob m, double speedMod) {
        this.m = m;
    ...
    public void advance() {
        ...
        new EntityController1_21_R7(m).moveTo(n.x, n.y, n.z, speedMod);
