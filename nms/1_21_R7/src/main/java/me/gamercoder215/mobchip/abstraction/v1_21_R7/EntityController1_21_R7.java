...
final class EntityController1_21_R7 implements EntityController {
    ...
    public EntityController1_21_R7(Mob m) {
        net.minecraft.world.entity.Mob nms = ChipUtil1_21_R7.toNMS(m);
