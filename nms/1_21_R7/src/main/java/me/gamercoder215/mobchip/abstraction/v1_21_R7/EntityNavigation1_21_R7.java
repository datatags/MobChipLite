...
final class EntityNavigation1_21_R7 implements EntityNavigation {
    ...
    public EntityNavigation1_21_R7(Mob m) {
        this.handle = ChipUtil1_21_R7.toNMS(m).getNavigation();
    ...
    public NavigationPath buildPath() {
        ...
        return new NavigationPath1_21_R7(new Path(toNodes(), null, true), m, speedMod);
    }
