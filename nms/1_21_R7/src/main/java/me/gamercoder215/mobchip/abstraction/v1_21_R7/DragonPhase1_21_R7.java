...
final class DragonPhase1_21_R7 implements DragonPhase {

    private final EnderDragon dragon;
    private final DragonPhaseInstance handle;

    public DragonPhase1_21_R7(EnderDragon dragon, DragonPhaseInstance handle) {
        this.dragon = dragon;
        this.handle = handle;
    }
    ...
    public @NotNull Location getTargetLocation() {
        return ChipUtil1_21_R7.fromNMS(handle.getFlyTargetLocation(), dragon.getWorld());
    }
