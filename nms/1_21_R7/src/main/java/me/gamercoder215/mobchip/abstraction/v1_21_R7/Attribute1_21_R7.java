...
final class Attribute1_21_R7 extends RangedAttribute implements Attribute {
    ...
    public Attribute1_21_R7(RangedAttribute a) {
    ...
    public Attribute1_21_R7(NamespacedKey key, double defaultV, double min, double max, boolean clientSide) {
