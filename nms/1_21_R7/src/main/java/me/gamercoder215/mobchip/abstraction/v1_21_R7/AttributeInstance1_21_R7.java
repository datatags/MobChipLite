...
import static org.bukkit.craftbukkit.v1_21_R7.attribute.CraftAttributeInstance.convert;

final class AttributeInstance1_21_R7 implements AttributeInstance {

    private final net.minecraft.world.entity.ai.attributes.AttributeInstance handle;
    private final Attribute a;

    public AttributeInstance1_21_R7(Attribute a, net.minecraft.world.entity.ai.attributes.AttributeInstance handle) {
        this.a = a;
        this.handle = handle;
    }
