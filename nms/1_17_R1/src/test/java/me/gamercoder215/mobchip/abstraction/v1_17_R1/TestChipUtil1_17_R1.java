...
public class TestChipUtil1_17_R1 {
    ...
    public void testNMSConversion() {
        ...
        for (EntityDamageEvent.DamageCause c : EntityDamageEvent.DamageCause.values()) Assertions.assertNotNull(ChipUtil1_17_R1.toNMS(c));
    ...
    public void testBukkitConversion() {
        // Other
        for (net.minecraft.world.Difficulty d : net.minecraft.world.Difficulty.values()) Assertions.assertNotNull(ChipUtil1_17_R1.fromNMS(d));
        for (net.minecraft.world.entity.ai.gossip.GossipType t : net.minecraft.world.entity.ai.gossip.GossipType.values()) Assertions.assertNotNull(ChipUtil1_17_R1.fromNMS(t));
    }

    @Test
    @DisplayName("Test ChipUtil1_17_R1#getFlags")
    public void testGetFlags() {
        OptimizedSmallEnumSet1_17_R1<Goal.Flag> set = new OptimizedSmallEnumSet1_17_R1<>(Goal.Flag.class);
        ...
        Set<Goal.Flag> flags = ChipUtil1_17_R1.getFlags(set.getBackingSet());
