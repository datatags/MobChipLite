...
import static org.bukkit.craftbukkit.v1_21_R3.attribute.CraftAttributeInstance.convert;
...
final class AttributeInstance1_21_R3 implements AttributeInstance {
    ...
    public AttributeInstance1_21_R3(Attribute a, net.minecraft.world.entity.ai.attributes.AttributeInstance handle) {
        this.a = a;
        this.handle = handle;
    }
